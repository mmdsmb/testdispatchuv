...
CREATE TABLE IF NOT EXISTS courseGroupe (
	...
	lieu_prise_en_charge_list varchar(255),
	destination_list varchar(255),
	date_heure_prise_en_charge_list timestamp with time zone,
	nombre_personne bigint NOT NULL,
...
-- ALTER TABLE for courseGroupe
ALTER TABLE courseGroupe
DROP COLUMN IF EXISTS lieu_prise_en_charge_list,
DROP COLUMN IF EXISTS destination_list,
DROP COLUMN IF EXISTS date_heure_prise_en_charge_list,
ADD COLUMN IF NOT EXISTS date_heure_prise_en_charge timestamp with time zone,
ADD COLUMN IF NOT EXISTS lieu_prise_en_charge varchar(255),
ADD COLUMN IF NOT EXISTS destination varchar(255),
ADD COLUMN IF NOT EXISTS lieu_prise_en_charge_json jsonb,
ADD COLUMN IF NOT EXISTS destination_json jsonb,
ADD COLUMN IF NOT EXISTS date_heure_prise_en_charge_json jsonb,
ADD COLUMN IF NOT EXISTS hash_lieu_prise_en_charge varchar(255),
ADD COLUMN IF NOT EXISTS hash_destination varchar(255),
ADD COLUMN IF NOT EXISTS date_time_window timestamp with time zone,
ADD COLUMN IF NOT EXISTS hash_route varchar(255);

-- ALTER TABLE for chauffeurAffectation
ALTER TABLE chauffeurAffectation
ADD COLUMN IF NOT EXISTS date_heure_prise_en_charge timestamp with time zone,
ADD COLUMN IF NOT EXISTS lieu_prise_en_charge varchar(255),
ADD COLUMN IF NOT EXISTS destination varchar(255),
ADD COLUMN IF NOT EXISTS prenom_nom_list TEXT;